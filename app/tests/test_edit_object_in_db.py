...
def test_edit_product() :
    ...
    mock_query_strings = {"id": to_be_edited_product.id,
    ...
    session.close()
    name_is_edited = after_edit_product.product_name == mock_query_strings["product_name"]
    code_is_edited = after_edit_product.product_code == mock_query_strings["product_code"]
    quantity_is_edited = after_edit_product.product_quantity == mock_query_strings["product_quantity"]
    price_is_edited = after_edit_product.price_per_unit == mock_query_strings["price_per_unit"]
    clear_db_tables()
    assert name_is_edited
